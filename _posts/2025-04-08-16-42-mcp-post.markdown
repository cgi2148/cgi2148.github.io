...
이제 많은 개발자들이 **Claude Desktop 앱**과 같은 AI 인터페이스에서 MCP 기능을 활용하여 AI의 한계를 확장하고자 합니다. 특히 **Claude Desktop**은 Anthropic의 AI 비서 Claude를 PC에서 실행할 수 있는 애플리케이션으로, 2024년 말 업데이트를 통해 MCP 기능을 지원하기 시작했습니다.
